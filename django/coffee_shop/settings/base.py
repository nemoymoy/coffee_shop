...
# YooKassa (ЮКасса)
YOOKASSA_SHOP_ID = os.environ.get('YOOKASSA_MERCHANT_ID', '')
YOOKASSA_SECRET_KEY = os.environ.get('YOOKASSA_API_KEY', '')
...
YOOKASSA_MERCHANT_ID = YOOKASSA_SHOP_ID
YOOKASSA_API_KEY = YOOKASSA_SECRET_KEY
YOOMONEY_SHOP_ID = YOOKASSA_SHOP_ID
YOOMONEY_SECRET_KEY_1 = YOOKASSA_SECRET_KEY
